...
<body>
    ...
    <div class="container my-4">
        <h2 class="text-center">Please Enter the Product Code and Product Name to delete that particular product details 🚮</h3>
            <br><br>
    ...
    -->
            ...
            <form action="PARTIALS/_deleteproduct.php" method="POST">
                <div class="mb-3">
