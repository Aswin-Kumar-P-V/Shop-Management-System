...
<body>
    ...
    <div class="container my-4">
        <h1 class="text-center">Please Enter The Product Code And Name Of Product Whose Details You Would Like to Edit 📝</h1>
        <form action="_editproduct2.php" method="post">
